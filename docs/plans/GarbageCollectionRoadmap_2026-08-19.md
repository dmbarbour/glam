...
Status: in progress; collector Phases C0, C1, C2A, and C2B and integration
Phase I0 are complete, Gate G0 is established, and the mandatory post-C1
review is complete. Collector Phase C2C.1a may proceed.
