...
| `SharedRuntimeNet`, `RuntimeNetCell`, `SharedRuntimeNetState`, `RuntimeNetDisturbance` | 8/8, 248/8, 224/8, 8/8 | The generic `Arc` owner, ownership-neutral synchronized cell, cell state, and edge-free wake companion. I5 replaces only the production core owner atomically with lazy/promise identity; individual topology entries remain ordinary storage. |
