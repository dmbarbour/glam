...
The 24 inventoried modules contain 200 compatibility occurrences after
...
| Reflection lifecycle, machine, protocol, requests, search, store | 6 | 100 | I3D.1-I3D.4 phase boundaries; I4F.1 machine/store root surfaces |
