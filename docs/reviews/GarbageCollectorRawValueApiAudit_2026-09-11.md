...
The production source tree contains 592 declarations whose signature directly
...
| --- | --- | ---: |
| function or method | regional access API | 75 |
...
| core values, managed cells, nets, and runtime roots | 34 | 23 | 6 | 49 | Keep access-qualified primitives; retire compatibility walkers with their shells; require access for raw construction, projection, comparison, and formatting. |
...
migrations, and the 486 authority-free operations remain latched until those
callers move.
