        ...
        let groups: &[(
            ...
            (
                ...
                &[
                    ...
                    "src/eval/annotation_machine.rs::RegionalAnnotationMachine::begin_recognized",
                    "src/eval/annotation_machine.rs::annotation_error_in",
                    "src/eval/annotation_machine.rs::builtin_value_in",
                    "src/eval/annotation_machine.rs::finish_metadata_update_in",
                    "src/eval/builtins.rs::apply_builtin_in",
                    "src/eval/builtins/net/builder.rs::apply_builder_builtin_in",
                    ...
                    "src/eval/effect_machine.rs::RegionalEffectMachine::poll_in",
                    "src/eval/effect_machine.rs::application_in",
                    "src/eval/effect_machine.rs::effect_call_in",
                    "src/eval/effect_machine.rs::effect_map_sequence_in",
                    "src/eval/list_transform_machine.rs::deferred_concat_in",
                    ...
                    "src/eval/list_transform_machine.rs::RegionalListConcatMachine::poll_in",
                    "src/eval/list_transform_machine.rs::RegionalListMapMachine::poll_in",
                    "src/eval/list_transform_machine.rs::RegionalTextLinesMachine::poll_in",
                    "src/eval/list_effect_machine.rs::RegionalListEffect::poll_in",
                    "src/eval/list_effect_machine.rs::flat_map_result_in",
                    "src/eval/list_effect_machine.rs::sequence_result_in",
                    "src/eval/builtin_machine.rs::RegionalNetMachine::poll_in",
                    "src/eval/builtins/net/netlist.rs::interaction_net_from_netlist_in",
                    "src/eval/net.rs::attach_net_many_in",
                    "src/eval/object_builtin_machine.rs::instance_from_plain_dict_in",
                    "src/eval/object_builtin_machine.rs::object_from_dict_in",
                    "src/eval/object_builtin_machine.rs::object_instance_in",
                    "src/eval/object_composition_machine.rs::application_value_in",
                    "src/eval/object_composition_machine.rs::finish_object_extension_in",
                    "src/eval/object_composition_machine.rs::plain_extension_in",
                    "src/eval/operator.rs::apply_core_operator",
                    "src/eval/operator.rs::constant_effect_in",
                    "src/eval/test_support.rs::FixtureNetLowerer::compile_lazy_into",
                    "src/eval/test_support.rs::lower_test_function_code_with_access",
                    "src/eval/whnf.rs::apply_whnf_builtin",
                    "src/eval/whnf.rs::apply_whnf_function",
