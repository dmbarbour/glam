...
fn raw_core_value_api_inventory_has_reviewed_dispositions() {
    ...
    let expected = BTreeMap::from([
        ...
        ((ApiKind::Function, ApiDisposition::Violation), 266),
        (
...
fn d2c_evaluator_boundary_manifest_is_exact() {
    ...
    assert_eq!(
        context_counts,
        BTreeMap::from([
            (D2cCurrentContext::EvaluatorStep, 8),
...
fn d2c_family_fingerprints_are_exact() {
    ...
    let expected = BTreeMap::from([
        ...
        (D2cFamily::NetBuiltins, 12_233_159_576_254_963_310),
    ]);
