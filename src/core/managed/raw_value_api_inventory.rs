...
fn raw_core_value_api_inventory_has_reviewed_dispositions() {
    ...
    let expected = BTreeMap::from([
        ...
        ((ApiKind::Function, ApiDisposition::Violation), 400),
        (
...
fn d2c_evaluator_boundary_manifest_is_exact() {
    ...
    assert_eq!(
        ...
        BTreeMap::from([
            ...
            (D2cFamily::DispatchScalarAndStrategy, 19),
    ...
    assert_eq!(
        context_counts,
        BTreeMap::from([
            (D2cCurrentContext::EvaluatorStep, 114),
