...
#[cfg(test)]
use super::super::{Diagnostic, ObjectExpr};
use super::super::{SyntaxExpr, SyntaxOperator};
#[cfg(test)]
...
#[cfg(test)]
pub(in crate::g_syntax) use legacy::parse_expr_result_with_diagnostics;
#[cfg(test)]
...
mod legacy {
    ...
    #[cfg(test)]
    pub(in crate::g_syntax::parser) fn parse_expr_result(text: &str) -> Result<SyntaxExpr, String> {
    ...
    pub(in crate::g_syntax::parser) fn parse_let_expr_result(
        text: &str,
        line: usize,
        diagnostics: &mut Vec<Diagnostic>,
        ...
        let (bindings, body_text) = match in_indices.first().copied() {
            ...
            None => match split_multiline_let(rest) {
                Ok((bindings, body)) => {
                    match parse_local_binding_texts(bindings, line, diagnostics) {
    ...
    pub(in crate::g_syntax::parser) fn parse_where_expr_result(
        text: &str,
        line: usize,
        diagnostics: &mut Vec<Diagnostic>,
    ) -> Option<Result<SyntaxExpr, String>> {
    ...
    pub(in crate::g_syntax::parser) fn parse_let_expr_from_parts(
        bindings_text: &str,
        body_text: &str,
        line: usize,
        diagnostics: &mut Vec<Diagnostic>,
    ...
    pub(in crate::g_syntax::parser) fn parse_let_expr_from_bindings(
    ...
    pub(in crate::g_syntax::parser) fn parse_local_bindings(
        text: &str,
        line: usize,
        diagnostics: &mut Vec<Diagnostic>,
    ...
    pub(in crate::g_syntax::parser) fn parse_local_binding_texts(
    ...
    pub(in crate::g_syntax::parser) fn parse_local_binding(
        text: &str,
        line: usize,
        diagnostics: &mut Vec<Diagnostic>,
    ...
    pub(in crate::g_syntax::parser) fn split_multiline_let(
        text: &str,
    ...
    pub(in crate::g_syntax::parser) fn parse_multiline_binding_texts(
        text: &str,
    ...
    pub(in crate::g_syntax::parser) fn split_top_level_keyword<'a>(
        text: &'a str,
        keyword: &str,
        from_end: bool,
    ) -> Option<(&'a str, &'a str)> {
    ...
    pub(in crate::g_syntax::parser) fn top_level_keyword_indices(
        text: &str,
        keyword: &str,
    ) -> Vec<usize> {
    ...
    pub(in crate::g_syntax::parser) fn top_level_token_indices(
        text: &str,
        token: &str,
    ) -> Vec<usize> {
    ...
    pub(in crate::g_syntax::parser) fn keyword_starts_at(
        text: &str,
        index: usize,
        keyword: &str,
    ) -> bool {
    ...
    pub(in crate::g_syntax::parser) fn is_name_char(ch: char) -> bool {
        ch.is_ascii_alphanumeric() || ch == '_'
    }

    pub(in crate::g_syntax::parser) fn split_top_level_semicolons(text: &str) -> Vec<&str> {
    ...
    pub(in crate::g_syntax::parser) fn split_top_level_binding_equals(
        text: &str,
    ) -> Option<(&str, &str)> {
    ...
    pub(in crate::g_syntax::parser) fn top_level_char_indices(
        text: &str,
        needle: char,
    ) -> Vec<usize> {
    ...
    pub(in crate::g_syntax::parser) fn matching_closing_delimiter(
        text: &str,
        open_index: usize,
    ) -> Option<usize> {
    ...
    pub(in crate::g_syntax::parser) fn parse_object_expr_result(
        text: &str,
        line: usize,
        diagnostics: &mut Vec<Diagnostic>,
    ) -> Option<Result<SyntaxExpr, String>> {
        ...
        let name = match name_text {
            Some(name_text) => {
                match parse_expr_result_with_diagnostics(name_text, line, diagnostics) {
    ...
    fn parse_object_expr_header(header: &str) -> Result<ParsedObjectExprHeader<'_>, String> {
        ...
        let deps = if rest.is_empty() {
            ...
            if deps.is_empty() {
                return Err(
                    "object expression `extends` requires at least one dependency".to_owned(),
                );
            }
            deps.split(',')
                .map(str::trim)
    ...
    pub(in crate::g_syntax::parser) fn split_before_object_expr_keyword(
        header: &str,
    ) -> (&str, &str) {
    ...
    pub(in crate::g_syntax::parser) fn parse_optional_object_expr_alias(
        rest: &str,
    ...
    pub(in crate::g_syntax::parser) fn parse_with_expr_result(
        text: &str,
        line: usize,
        diagnostics: &mut Vec<Diagnostic>,
    ) -> Option<Result<SyntaxExpr, String>> {
    ...
    pub(in crate::g_syntax::parser) fn parse_optional_with_alias(
        text: &str,
    ) -> (&str, Option<String>) {
