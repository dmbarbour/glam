...
| `evaluation/access.rs` | I3 scoped evaluator authority, thread-bound mutator-free evaluator-step context, claim-derived poll context, one source-latched direct-compatibility admission, and temporary machine-completion root seam |
