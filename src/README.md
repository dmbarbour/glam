...
| `eval/builtin_machine.rs` | Durable saturated-builtin owners; assertion, conditional-list-front, and numeric operands use resumable WHNF demand while immediate validation/arithmetic remains callback-free |
