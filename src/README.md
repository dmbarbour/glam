...
| `evaluation.rs`, `evaluation/coordinator.rs`, `evaluation/executor.rs` | Demand-owner leases, transitional session machine stores, runtime-owned reflection/deferred/spark work, coordination, and worker lifecycle |
