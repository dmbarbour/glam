...
| `evaluation/access.rs` | I3 scoped evaluator authority, claim-derived mutator-free poll context, and temporary machine-completion root seam; opaque callback/wait-capable calls remain unopened until partitioned |
