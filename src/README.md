...
| `eval/builtin_machine.rs` | Durable saturated-builtin owners; assertion, conditional-list-front, numeric, and provenance operands use resumable WHNF demand while immediate validation, arithmetic, and opaque-origin inspection remain callback-free |
