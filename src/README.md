...
| `eval/builtins/net/builder.rs` | PNC2-PNC4 private pure state-over-list composition, protected fixed-width builder state, resumable state/control/construction operations, and exact private API |
