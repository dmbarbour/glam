...
| `evaluation.rs`, `evaluation/coordinator.rs`, `evaluation/executor.rs` | Session machine slots, runtime-owned reflection/deferred/spark work, coordination, and worker lifecycle |
