...
| `eval/builtin_machine.rs`, `eval/comparison_machine.rs`, `eval/strategy_machine.rs` | Durable saturated-builtin owners; assertion, conditional-list-front, numeric, provenance, recursive comparison, and strategy operands use resumable WHNF demand while immediate validation, arithmetic, opaque-origin inspection, and post-access spark admission remain callback-free |
