...
| `g_syntax/parser/expression.rs`, `structural.rs`, `do_expr.rs`, `conditional.rs` | Ordinary precedence grammar, structural/postfix resumption, `let`/object/`with` forms, do statements, and prefix conditionals |
