...
| `eval/builtins/net/builder.rs` | PNC2/PNC3 private pure state-over-list composition, protected fixed-width builder state, and resumable state/control operations |
