...
| `eval/builtin_machine.rs`, `eval/comparison_machine.rs` | Durable saturated-builtin owners; assertion, conditional-list-front, numeric, provenance, and recursive comparison operands use resumable WHNF demand while immediate validation, arithmetic, and opaque-origin inspection remain callback-free |
