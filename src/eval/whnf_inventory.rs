...
const EXPECTED_OCCURRENCES: usize = 305;
const EXPECTED_FINGERPRINT: u64 = 13_812_119_740_430_377_017;
const EXPECTED_SIGNAL_COUNTS: &[(Signal, usize)] = &[
    (Signal::EvalValue, 107),
    (Signal::EvalLazy, 2),
    (Signal::EvalPromise, 1),
    (Signal::ApplyValue, 20),
