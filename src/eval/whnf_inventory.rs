...
const EXPECTED_OCCURRENCES: usize = 259;
const EXPECTED_FINGERPRINT: u64 = 13_105_144_561_292_753_757;
const EXPECTED_SIGNAL_COUNTS: &[(Signal, usize)] = &[
    (Signal::EvalValue, 57),
    (Signal::EvalLazy, 2),
    (Signal::EvalPromise, 1),
    (Signal::ApplyValue, 12),
    (Signal::ApplyValues, 3),
